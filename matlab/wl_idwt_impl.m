function x=wl_idwt_impl(x, wave_name, varargin)
    ...
    % 
   % [f, prefilter, offset_L, offset_R]=wl_find_kernel(wave_name, length_signal, 0)
    % save('wl_kernel.mat', 'f', 'prefilter', 'offset_L', 'offset_R');
    % ...
    % load('wl_kernel.mat');
    % x = wl_idwt1_impl_internal(x, f, prefilter, [offset_L offset_R]);
    %     
